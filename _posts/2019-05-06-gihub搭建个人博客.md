...
- 将公钥 github_rsa.pub 内容添加到 github
    复制github_rsa.pub粘贴到你的git网站的ssh配置中![git-ssh](https://raw.githubusercontent.com/wenmeiyu/wenmeiyu.github.io/master/_posts/image/git-ssh.PNG)
...
![fork](https://raw.githubusercontent.com/wenmeiyu/wenmeiyu.github.io/master/_posts/image/fork.png]，即可fork到你自己的仓库中

#### 2.修改_config.yml文件

这个也很简单，如下图![peizhi](https://raw.githubusercontent.com/wenmeiyu/wenmeiyu.github.io/master/_posts/image/peizhi.png],把标黄的部分都改成你自己的内容，划红线的图片可以修改为你自己的图片
